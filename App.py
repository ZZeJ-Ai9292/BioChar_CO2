...
with col1:
    ...
    st.markdown('<p style="font-size: 12px; color: black; font-weight: bold; font-family: \'Times New Roman\', Times, serif; margin-bottom: 0.1px;">VM (%)</p>', unsafe_allow_html=True)
