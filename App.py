...
with col1:
    ...
    feature1 = st.slider('<p style="color: blue;">VM (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=76.42, unsafe_allow_html=True)
    feature2 = st.slider('<p style="color: green;">Ash (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=3.98, unsafe_allow_html=True)
    feature3 = st.slider('<p style="color: orange;">FC (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=19.61, unsafe_allow_html=True)
    feature4 = st.slider('<p style="color: purple;">C (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=46.44, unsafe_allow_html=True)
    feature5 = st.slider('<p style="color: pink;">H (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=6.36, unsafe_allow_html=True)
    feature6 = st.slider('<p style="color: brown;">N (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=0.91, unsafe_allow_html=True)
    feature7 = st.slider('<p style="color: gray;">S (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=0.38, unsafe_allow_html=True)
    feature8 = st.slider('<p style="color: teal;">O (%)</p>', min_value=0.00, max_value=100.00, step=0.01, value=45.92, unsafe_allow_html=True)
