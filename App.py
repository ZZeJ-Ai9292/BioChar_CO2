...
with col2:
    ...
    feature26 = st.slider('Wash-Pre (HCl/none/H<sub>2</sub>O —— −1/0/1)', min_value=-1, max_value=1, step=1, value=0)
    feature27 = st.slider('Wash-Post (HCl/none/H<sub>2</sub>O —— −1/0/1)', min_value=-1, max_value=1, step=1, value=-1)
...
with col3:
    ...
    if feature9 == 0:
        ...
        feature10 = st.slider('Imp-Agent (pK<sub>B</sub>)', min_value=-1.10, max_value=20.00, step=0.01, value=-0.56)
...
with col4:
    ...
    if feature16 == 0:
        ...
        feature17 = st.slider('Mix-Agent (pK<sub>B</sub>)', min_value=-1.10, max_value=11.30, step=0.01, value=0.00)
...
with col5:
    ...
    if feature21 == 0:
        ...
        feature22 = st.slider('Gas-Agent (steam/CO<sub>2</sub>/None(−1/1/0))', min_value=-1, max_value=1, step=1, value=0)
        ...
        feature22 = st.slider('Gas-Agent (steam/none/CO<sub>2</sub> —— -1/0/1)', min_value=-1, max_value=1, step=1, value=0)
        feature23 = st.slider('Gas-Flow (mL/min)', min_value=0.0, max_value=100.0, step=0.1, value=0.0)
...
with col6:
    ...
    feature31 = st.slider('CO<sub>2</sub>Ad-T (°C)', min_value=0, max_value=75, step=25, value=0)
    feature32 = st.slider('CO<sub>2</sub>Ad-P (bar)', min_value=0.1, max_value=1.0, step=0.1, value=1.0)
